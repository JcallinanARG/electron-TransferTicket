function openReasonCodeTabs(evt, tabName) {
    ...
    //   userType =  window.getCookie("userType")
     ...
     function loadjsGridReasonCode() {
        var searchParam = {
          searchParam: document.getElementById('reasoncodeSearchInput').value,
      };
    ...
    console.log(searchParamJSON)
        ...
        $("#reasonCodejsGrid").jsGrid({
            ...
            fields: [
                { name: "ReasonCodeID", title: "Reason Code ID", type: "text", width: 200 },
                { name: "ReasonCodeIseries", title: "Reason Code Iseries", type: "text", width: 200 },
                { name: "ReasonCode", title: "Reason Code", type: "text", width: 200 }
